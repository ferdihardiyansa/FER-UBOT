...
DEF_UNAPPROVED_MSG = (
    ...
    "╰━━━━━━━━━━━━━━━━━╯\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"KALO NGECHAT MAJIKAN GUA ITU SALAM,\nHABIS ITU SABAR TUNGGU MAJIKAN GUA BALES,\nKALO GA DI BALES - BALES, LU JANGAN NYEPAM, TUNGGU MAJIKAN GUA NERIMA PESAN LU\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 ⭐️FER-𝐔𝐁𝐎𝐓⭐️\n"
...
@bot.on(ram_cmd(outgoing=True, pattern=r"(?:setuju|ok)\s?(.)?"))
...
@bot.on(ram_cmd(outgoing=True, pattern=r"block$"))
...
@bot.on(ram_cmd(outgoing=True, pattern=r"unblock$"))
